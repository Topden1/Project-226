...
##This one is incorrect. no key inputed for def on_press(): <<
 def on_press():
    #global current_index, correct, incorrect, sentence
    #if key == Key.shift:
        #pass
...
##this one is correct it has. ELIF for key == key.backspace <<
def on_press(key):
    #global current_index, correct, incorrect, sentence
    #if key == Key.shift:
        #pass
...
##This is incorrect since it includes global, why state it again if we already established this for def on_press(key).
...
##This is incorrect doesn't include accuracy <<
...
##This is incorrect doesn't have return false in the end <<
